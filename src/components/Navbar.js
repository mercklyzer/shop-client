...
const Navbar = props => {
    return (
        <nav className="flex h-8 sm:h-16 w-full px-2 py-6 sm:py-0 sm:px-4 border-2">
            <div className="hidden basis-1/2 sm:flex sm:basis-1/3 flex-start items-center">
                <div className="inline-block mr-2">EN</div>
                <div className="flex px-2 py-1 mr-8">
                    <input className="block focus:outline-none w-full" placeholder="Search"/>
                    <svg class="w-6 h-6 block" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                </div>
            </div>
            ...
            <div className="basis-1/2 flex sm:basis-1/3 md:basis-1/3 md:flex justify-end items-center mr-2">
                <div className="hidden md:block mr-6">REGISTER</div>
                <div className="hidden md:block mr-6">SIGN IN</div>
