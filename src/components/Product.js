...
const Product = ({image, id}) => {
    return (
        <div className={`w-full flex justify-center items-center bg-sky-100 p-4 max-h-64 relative group`}>
            ...
            <div className="hidden group-hover:flex absolute top-0 left-0  w-full h-full justify-center items-center z-30">
                ...
                <div className="rounded-full bg-white p-2 mx-3 cursor-pointer">
